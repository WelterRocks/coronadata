...
class DataHandler
{
    ...
    public function retrieve($target_file = null, $cache_time = 14400, $compression_level = 9, $not_json_encoded = false, $force_content_type = null)
    {
        ...
        if ($this->use_genesis)
            ...
            $length = $this->http_handler->retrieve("get", null, null, null, $data, $force_content_type);
